...
export default function CellActionLink({ LinkId }: { LinkId: string }) {
  ...
  const onDelete = async () => {
    ...
    try {
      ...
      const res = await axios.delete(`/api/navbar/link/${LinkId}`);
  ...
  return (
    <>
      <DeleteModal 
        isOpen={deleteModal}
        onCancel={onDelete}
        text="Sei sicuro di voler cancellare questo link?"
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            disabled={loading}
            onClick={() => router.push(`/admin/navbar/${LinkId}`)}
