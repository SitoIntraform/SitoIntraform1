    ...
    <div className="w-full">
      <div className="w-full flex lg:flex-row flex-col-reverse gap-10 items-start">
        <div className="w-full lg:w-[70%] flex-col flex gap-3">
          ...
          <div>
            <motion.div className="text-center h2Desktop !text-primaryDesign my-[50px]">
        ...
        <motion.div
          ...
          initial={"hidden"}
          whileInView={"show"}
          className="w-full lg:w-[30%] lg:border-textDesign/50 lg:p-4 lg:border-2 lg:sticky lg:top-28"
        >
